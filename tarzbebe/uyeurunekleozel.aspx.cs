...
namespace tarzbebe
{
    public partial class uyeurunekleozel : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                baglanti.Open();
                OleDbDataAdapter adaptor = new OleDbDataAdapter("select * from adminuyeurunekle where urun_no=" + gelenid, baglanti);
