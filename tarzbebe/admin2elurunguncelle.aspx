<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin2elurunguncelle.aspx.cs" Inherits="tarzbebe.admin2elurunguncelle" %>
...
<div style="margin-top:10px;">
    ...
    <asp:Button ID="Button1" runat="server" Text="Güncelle" 
     ...
     <p class="text-center">
    <asp:Button ID="Button2" runat="server" Text=" Ekle " 
            CssClass="btn btn-success text-center" onclick="Button2_Click" />
    </p>
