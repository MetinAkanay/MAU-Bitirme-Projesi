<%@ Page Title="" Language="C#" MasterPageFile="~/sablon.Master" AutoEventWireup="true" CodeBehind="erkekbebekpantolon.aspx.cs" Inherits="master.WebForm2" %>
...
<div class="container">
 <asp:Repeater runat="server" ID="tekrar">
            ...
            <div class="col-md-4 hover" style="text-align:center; padding:5px; margin-bottom:20px;">
                ...
                <a href="erkekbebekpantolonurunozel.aspx?id=<%# Eval("urun_no") %>"><img src=<%#Eval("urun_resim") %> class="img-responsive" style="widht:400px; height:240px; margin:0px auto; margin-bottom:0px;" /></a>
