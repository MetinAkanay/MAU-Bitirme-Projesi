...
namespace tarzbebe
{
    public partial class _2elsatisolanlarguncelle : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                if (IsPostBack == false)
                {
                    ...
                    baglanti.Open();
                    OleDbCommand komut = new OleDbCommand("select * from adminuyeurunekle where urun_no=" + urunno, baglanti);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            OleDbConnection baglanti = new OleDbConnection("Provider=Microsoft.Ace.OleDb.12.0;Data Source=" + Server.MapPath("urunlersite.accdb"));
            baglanti.Open();
            OleDbCommand sorgu = new OleDbCommand("update adminuyeurunekle set urun_adi=@urun_adi,urun_fiyat=@urun_fiyat,urun_yas=@urun_yas,urun_kategori=@urun_kategori,urun_cins=@urun_cins,urun_kodu=@urun_kodu,urun_taksitlifiyat=@urun_taksitlifiyat,tel=@tel,urun_kumas=@urun_kumas where urun_no=" + urunno, baglanti);
