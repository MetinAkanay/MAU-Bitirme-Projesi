<%@ Page Title="" Language="C#" MasterPageFile="~/sablon.Master" AutoEventWireup="true" CodeBehind="indexurunozel.aspx.cs" Inherits="master.WebForm14" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Repeater runat="server" ID="tekrar">
        ...
        <div class="col-md-6" style="margin-top:30px;">
                <img src=<%#Eval("urun_resim") %> class="img-responsive aw-zoom" style="margin:0px auto; margin-bottom:0px; widht:400px; height:240px;" /></a>
                </div>
