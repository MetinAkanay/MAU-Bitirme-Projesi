<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="2elurunlerlistelemeadmin.aspx.cs" Inherits="tarzbebe._2elurunlerlistelemeadmin" %>
    ...
    <th>Ürün Resim Yolu</th>
     ...
     <h4 class="text-center" style="margin-right:-70px;">Ürün Ekle</h4>
        ...
        <asp:Repeater runat="server" ID="tekrar">
            ...
            <td><a href="2elsatisolanlarguncelle.aspx?id=<%# Eval("urun_no") %>" class="btn btn-primary"><span class="glyphicon glyphicon-refresh"></span> Güncelle ve Ekle</a></td>
            <td><%# Eval("urun_no") %></td>
            <td><%# Eval("urun_adi") %></td>
            ...
            <td> <a href="adminsil2el.aspx?id=<%# Eval("urun_no") %>" class="btn btn-danger">Sil <span class="glyphicon glyphicon-remove"></span> </a></td>
            </tr>
