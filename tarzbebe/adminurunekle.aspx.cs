        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    baglanti.Open();
                    OleDbCommand komut = new OleDbCommand("insert into anasayfa_urunler (urun_adi,urun_fiyat,urun_yas,urun_kategori,urun_cins,urun_taksitlifiyat,urun_kodu,urun_kumas,urun_resim) values(@urun_adi,@urun_fiyat,@urun_yas,@urun_kategori,@urun_cins,@urun_taksitlifiyat,@urun_kodu,@urun_kumas,@urun_resim)", baglanti);
                    ...
                    baglanti.Close();
                    yon.InnerHtml="<meta http-equiv='refresh' content='1,url=admin.aspx'>";
