<%@ Page Title="" Language="C#" MasterPageFile="~/sablon.Master" AutoEventWireup="true" CodeBehind="uyeurunekleozel.aspx.cs" Inherits="tarzbebe.uyeurunekleozel" %>
    ...
    <asp:Repeater runat="server" ID="tekrar">
        ...
        <div class="col-md-6" style="margin-top:30px;">
                ...
                <h2 style="font-size:22px; margin-top:0px;"><%#Eval("urun_adi") %><%#Eval("urun_yas") %></h2></h2>
                           <h2 style="font-size:22px; margin-bottom:0px; margin-top:0px;""><%#Eval("tel") %></h2>
                ...
                <p class="text-center" style="font-size:20px; margin-top:400px;">Ürün Özellikleri</p>
